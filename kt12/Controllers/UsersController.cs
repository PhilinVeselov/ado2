...
namespace kt12.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserName,Email,UserProfile")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,Email,UserProfile")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
